...
enum socket_options {
    ...
    GRAPHQL_SCHEMA = 400,
    GRAPHQL_INTROSPECTION = 401,
    GRAPHQL_PLAYGROUND = 402,
    GRAPHQL_MAX_QUERY_DEPTH = 403,
    GRAPHQL_MAX_QUERY_COMPLEXITY = 404,
    GRAPHQL_TIMEOUT = 405,
    GRAPHQL_SUBSCRIPTIONS = 406,
    GRAPHQL_CORS_ORIGINS = 407,
    GRAPHQL_RESOLVER_TIMEOUT = 408,
    GRAPHQL_QUERY_CACHE = 409,
    GRAPHQL_SCHEMA_FILE = 410,
    GRAPHQL_ENDPOINT_PATH = 411,
    GRAPHQL_WS_ENDPOINT = 412,
    GRAPHQL_VALIDATION_RULES = 413,
    GRAPHQL_PERSISTED_QUERIES = 414,
    GRAPHQL_DEBUG_MODE = 415,
    GRAPHQL_EXTENSIONS = 416,
    GRAPHQL_FIELD_EXTENSIONS = 417,
    GRAPHQL_TRACING = 418,
    GRAPHQL_CUSTOM_SCALARS = 419,
    
    // gRPC options: 420-439
    GRPC_SERVICE_CONFIG = 420,
    GRPC_MAX_MESSAGE_SIZE = 421,
    GRPC_KEEPALIVE_TIME = 422,
    GRPC_KEEPALIVE_TIMEOUT = 423,
    GRPC_REFLECTION_ENABLE = 424,
    GRPC_HEALTH_CHECK = 425,
    GRPC_COMPRESSION = 426,
    GRPC_METADATA = 427,
    GRPC_DEADLINE = 428,
    GRPC_RETRY_POLICY = 429,
    GRPC_TARGET_ADDRESS = 430,
    GRPC_PROTO_FILE = 431,
    GRPC_TLS_ENABLED = 432,
    GRPC_TLS_CERT_FILE = 433,
    GRPC_TLS_KEY_FILE = 434,
    GRPC_TLS_CA_FILE = 435,
    GRPC_MAX_CONNECTIONS = 436,
    GRPC_CONNECTION_TIMEOUT = 437,
    GRPC_LOAD_BALANCING = 438,
    GRPC_DEBUG_MODE = 439,
    
    // Reserved ranges for future expansion
    // 440-499: Future protocol options
...
enum socket_option_category {
    ...
    OPTION_CATEGORY_GRAPHQL = 12,
    OPTION_CATEGORY_GRPC = 13,
    OPTION_CATEGORY_INTERNAL = 14
};
...
#define IS_GRAPHQL_OPTION(opt)      ((opt) >= 400 && (opt) <= 419)
#define IS_GRPC_OPTION(opt)         ((opt) >= 420 && (opt) <= 439)
...
#define GET_OPTION_CATEGORY(opt) \
    (IS_HTTP_OPTION(opt) ? OPTION_CATEGORY_HTTP : \
     ...
     IS_GRAPHQL_OPTION(opt) ? OPTION_CATEGORY_GRAPHQL : \
     IS_GRPC_OPTION(opt) ? OPTION_CATEGORY_GRPC : \
...
#define DEFAULT_GRAPHQL_MAX_QUERY_DEPTH 15
#define DEFAULT_GRAPHQL_MAX_QUERY_COMPLEXITY 1000
#define DEFAULT_GRAPHQL_TIMEOUT 30000
#define DEFAULT_GRAPHQL_RESOLVER_TIMEOUT 5000
#define DEFAULT_GRPC_MAX_MESSAGE_SIZE 4194304
#define DEFAULT_GRPC_KEEPALIVE_TIME 30000
#define DEFAULT_GRPC_KEEPALIVE_TIMEOUT 5000
#define DEFAULT_GRPC_DEADLINE 30000
#define DEFAULT_GRPC_CONNECTION_TIMEOUT 10000
...
#define MIN_GRAPHQL_QUERY_DEPTH 1
#define MAX_GRAPHQL_QUERY_DEPTH 50
#define MIN_GRAPHQL_QUERY_COMPLEXITY 1
#define MAX_GRAPHQL_QUERY_COMPLEXITY 10000
#define MIN_GRAPHQL_TIMEOUT 1000
#define MAX_GRAPHQL_TIMEOUT 300000
#define MIN_GRPC_MESSAGE_SIZE 1024
#define MAX_GRPC_MESSAGE_SIZE 67108864
#define MIN_GRPC_KEEPALIVE_TIME 5000
#define MAX_GRPC_KEEPALIVE_TIME 300000
#define MIN_GRPC_DEADLINE 1000
#define MAX_GRPC_DEADLINE 600000
