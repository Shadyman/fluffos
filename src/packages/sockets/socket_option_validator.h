...
struct ValidationContext {
    ...
    std::map<socket_options, mixed> current_options;  // Currently set options
...
public:
    ...
    ValidationResult validate_option_set(const std::map<socket_options, mixed>& options,
                                       const ValidationContext& context) const;
    
    ValidationResult validate_socket_mode_compatibility(int socket_mode,
                                                       const std::map<socket_options, mixed>& options) const;
    ...
    ValidationResult validate_float_option(socket_options option, float value,
                                         const ValidationContext& context) const;
    ValidationResult validate_mapping_option(socket_options option, const std::map<std::string, mixed>& value,
                                           const ValidationContext& context) const;
    ValidationResult validate_array_option(socket_options option, const std::vector<mixed>& value,
                                         const ValidationContext& context) const;
    
    // Protocol-specific validation
    ValidationResult validate_http_options(const std::map<socket_options, mixed>& options,
                                         const ValidationContext& context) const;
    ValidationResult validate_rest_options(const std::map<socket_options, mixed>& options,
                                         const ValidationContext& context) const;
    ValidationResult validate_websocket_options(const std::map<socket_options, mixed>& options,
                                              const ValidationContext& context) const;
    ValidationResult validate_mqtt_options(const std::map<socket_options, mixed>& options,
                                         const ValidationContext& context) const;
    ValidationResult validate_external_options(const std::map<socket_options, mixed>& options,
                                              const ValidationContext& context) const;
    ValidationResult validate_tls_options(const std::map<socket_options, mixed>& options,
                                        const ValidationContext& context) const;
    ValidationResult validate_cache_options(const std::map<socket_options, mixed>& options,
                                          const ValidationContext& context) const;
    ...
    ValidationResult check_conflicting_options(const std::map<socket_options, mixed>& options) const;
    ...
    mixed get_default_value(socket_options option) const;
...
private:
    ...
    bool check_resource_limits(socket_options option, const mixed& value) const;
    bool validate_security_constraints(socket_options option, const mixed& value,
                                     const ValidationContext& context) const;
};
